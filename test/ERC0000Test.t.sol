...
import {Predicates} from "../src/predicates/Predicates.sol";
...
contract ERC0000Test is Test {
    ...
    function setUp() public virtual {
        ...
        predicates = address(new Predicates());
        proxy = deployProxy(dictionary, predicates, "");
    }

    function deployProxy(address _dictionary, address _predicates, bytes memory _initData) internal virtual returns (address) {
        return address(new ERC0000Proxy(_dictionary, _predicates, _initData));
    }
